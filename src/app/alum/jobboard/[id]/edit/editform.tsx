    ...
    return(
        <>
            <div className="mt-16 w-full">
                <form action={updateJobWithId} className="bg-white shadow-md rounded-lg p-6 border border-gray-200 w-full">
                    <h2 className="text-xl font-semibold text-indigo-700 mb-6">Edit Job Listing</h2>
