...
export async function POST(req:Request){
    try{
      ...
      return NextResponse.json({msg:"your form response is successfully submitted", id:scholarshipForm.id},{status:200})
    }catch(e){
        console.log(e)
...
return NextResponse.json({msg:"your form response is successfully deleted"},{status:200})
  }catch(e){
      console.log(e)
      return NextResponse.json({msg:"sorry error occurred in the session please try again later"},{status:400})
