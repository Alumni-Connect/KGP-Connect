...
export async function GET(req:Request){
  ...
  if(!scholarships){
    ...
    return NextResponse.json({scholarships,msg:"hey there your shcolarhsip is already createed try to manage it in a way more thna it is requeriredd"},{status:200})
