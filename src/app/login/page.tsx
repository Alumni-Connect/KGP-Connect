    ...
    <div className="flex flex-col md:flex-row h-screen w-full bg-white relative overflow-hidden">
      ...
      <div className="flex items-center justify-center md:w-1/2 w-full p-6 md:p-12 relative z-10">
        <div className={`w-full max-w-md perspective-1000 ${isFlipped ? 'rotate-y-180' : ''} duration-1000 relative preserve-3d`}>
          {/* Login Form - Front */}
          <div className={`w-full p-8 rounded-3xl shadow-xl bg-white animate-fade-in-up animation-delay-150 ${isFlipped ? 'hidden' : 'block'}`}>
          ...
          {/* Register Form - Back */}
          <div className={`w-full p-8 rounded-3xl shadow-xl bg-white animate-fade-in-up animation-delay-150 relative top-0 ${isFlipped ? 'block' : 'hidden'}`}>
