...
const InstitutionalDevelopmentPage = () => {
  const [activeTab, setActiveTab] = useState("The Institutional Development Program");
      ...
      <main className="flex-1 bg-white shadow-md p-10 ">
        {
          ...
          <p className="mb-4">
            <strong>Mission:</strong> To support the institute’s offer to strengthen
            domestic ranking as well as enhancing the KGP’s international stature.
          </p>
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-700">
              ...
              <li>
                Leverage the alumni and corporate relations for the growth of the
                Institute
              </li>
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Need For ID Program:</h2>
            <ul className="list-disc pl-6 text-gray-700">
              <li>Many IITs</li>
              <li>Foreign university entry</li>
              <li>Scale and sustainability</li>
              <li>
                Need for an organized, timely, result-oriented, effective program
                structure
              </li>
            </ul>
          </section>
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Components of ID Program:</h2>
            <ul className="list-disc pl-6 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Advisory Board Members</h2>
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-4">
            <img src="/Gopalakrishna.png" alt="Mr. R. Gopalkrishnan" width={150} height={150} className="rounded-lg" />
            <div>
              <h3 className="text-xl font-semibold">Mr. R. Gopalkrishnan (ECE/1967/VS) - Alumni (India)</h3>
              <p>
                Mr. Gopalkrishnan is currently the CEO of The Mindworks. He has served as Chairman of Unilever Arabia,
                MD of Brooke Bond Lipton, and Vice Chairman of Hindustan Lever. He has been deeply engaged in the growth
                of the TATA Group and served in multiple leadership roles. He is also the author of six books.
              </p>
            </div>
          </div>
          
          <div className="flex items-center gap-4">
            <img src="/ArjunMalhotra1.png" alt="Mr. Arjun Malhotra" width={150} height={150} className="rounded-lg" />
            <div>
              <h3 className="text-xl font-semibold">Mr. Arjun Malhotra (EC/1970/RP) - Alumni (US)</h3>
              <p>
          ...
          <div className="flex items-center gap-4">
            <img src="/Matt.png" alt="Mr. Arjun Malhotra" width={150} height={150} className="rounded-lg" />
            <div>
              <h3 className="text-xl font-semibold">Mr. Matt Ter Molen - Non-Alumni (US)</h3>
              <p>
          ...
          <div className="flex items-center gap-4">
            <img src="/PrabhaKanth.png" alt="Mr. Arjun Malhotra" width={150} height={150} className="rounded-lg" />
            <div>
              <h3 className="text-xl font-semibold">Dr. Prabhakant Sinha (1970/B Tech/ME/PH) - Alumni (US)</h3>
              <p>
          ...
          <div className="flex items-center gap-4">
            <img src="/Amitpatra.png" alt="Mr. Arjun Malhotra" width={150} height={150} className="rounded-lg" />
            <div>
              <h3 className="text-xl font-semibold">Mr. B.K. Syngal (1961/B Tech/EC/RP) & (1962/M Tech/EC) - Alumni (India)</h3>
              <p>
          ...
          <div className="flex items-center gap-4">
            <img src="/BY.png" alt="Mr. Arjun Malhotra" width={150} height={150} className="rounded-lg" />
            <div>
              <h3 className="text-xl font-semibold">Expert Advisor: Prof. Amit Patra (1984/B Tech/EE/RK), (1986/M Tech/EE) & (1990/Ph D/EE)</h3>
              <p>
        ...
        {
          activeTab === "Domestic Chapters" &&
          <ChaptersTable />
        }
        {
          activeTab === "Global Chapters" &&
          <ChaptersTable />
        }
        {
          activeTab === "Students' Alumni Cell" &&
          <AlumniCell />
        }
