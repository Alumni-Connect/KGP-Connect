...
const contributors: Contributor[] = [
  {
    ...
    message: "(1967/B Tech/AG/RK) Chairman, Everest group LLC",
  },
  {
    name: "Praveen Chaudhary",
    image: "/joy-of-giving/2.png",
    message:
      "(1961/B Tech/MT/AZ) Director (Retired), Brookhaven National Laboratory, NY",
  },
  {
  ...
  },
  {
    ...
    message:
      "(1967/B Tech/MT/RP) Director (RETIRED) Chalke Atomic Research Centre",
  },
  {
    name: "Srikumar Banerjee",
    image: "/joy-of-giving/5.png",
    message:
      "(1967/B Tech/MT/RP) Director (RETIRED) Bhabha Atomic Research Centre",
  },
  {
    name: "Anjan Bose",
    image: "/joy-of-giving/6.png",
    message:
      "(1967/B Tech/EE/RK) Vice President (2008), Washington State University",
  },
  {
    name: "Prem Vat",
    image: "/joy-of-giving/7.png",
    message:
      "(1966/B Tech/ME/RP) Professor of Eminence & Chief Mentor, The NorthCap University, Gurugram",
  },
  {
  ...
  },
  {
    ...
    message:
      "(1979/B Tech/EC) University of Texas, Austin, Cockrell Family Regents Chair Professor of Electrical and Computer Engineering and Director, Microelectronics Research Center",
  },
  {
    name: "A Rajaputhy",
    image: "/joy-of-giving/11.png",
    message:
      "(1972/B Tech/EE) Former Director, National Aerospace Laboratories",
  },
  {
    name: "Arun Sarin",
  ...
  },
  {
    ...
    message:
      "(1960/B Tech/CE) Distinguished Visiting Professor, Lee Kuan Yew School of Public Policy",
  },
  {
    name: "Ravinder Nath Khanna",
    image: "/joy-of-giving/14.png",
    message:
      "(1967/B Tech/EE/RP) Chairman & Managing Director, Controls And Switchgear Contactors Limited",
  },
  {
...
export default function JoyOfGiving() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
      <h2 className="text-2xl sm:text-3xl font-bold border-b-4 border-indigo-500 inline-block">
        Joy Of Giving
      </h2>
      <p className="text-gray-600 mt-2 mb-6 text-sm sm:text-base">
        Celebrating the true Joy of Giving, showcasing stories that inspire and
        drive the Institute’s vision.
      </p>
      <div className="flex flex-col lg:flex-row w-full gap-4 items-center justify-center">
        ...
        <div className="flex  justify-center items-center gap-6">
          <div className="relative bg-white shadow-lg rounded-lg p-6 px-10 flex flex-col items-center text-center w-full max-w-md">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mt-3">
              {contributors[currentIndex].name}
            </h3>
            <p className="text-gray-600 mt-2 text-sm sm:text-base">
              {contributors[currentIndex].message}
            </p>
            <p className="text-gray-700 mt-2 text-sm sm:text-base py-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima
              aliquid optio odit, commodi eos quaerat dolore tempora sint?
              Reiciendis, officiis!
            </p>
            ...
            <button
              onClick={prevSlide}
              className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-orange-500 p-2 rounded-full text-white"
            >
              <ChevronLeft size={18} />
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 p-2 rounded-full text-white"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-6">
          {contributors.map((contributor, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center bg-gray-100 p-4 rounded-lg shadow-sm"
            >
              <img
