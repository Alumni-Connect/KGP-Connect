...
export default function JoyOfGiving() {
  ...
  return (
    <div className="w-full mx-auto  py-10 px-8">
      <h2 className="text-3xl font-bold border-b-4 border-indigo-500 inline-block ">
        Joy Of Giving
      </h2>
      ...
      <div className="flex justify-evenly items-center gap-4">
        <div className="relative bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center w-1/3">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-[#fd7e14] p-2 rounded-full text-white"
          >
            <ChevronLeft size={24} />
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#fd7e14] p-2 rounded-full text-white"
          >
