    ...
    <div className="p-3 w-5/6 mt-16 mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        ...
        <button
          ...
          onClick={() => {
            router.push("scholarship/update");
          }}
        >
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      {scholarship.createdAt.toISOString().split("T")[0]}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      {scholarship.lastDate.toISOString().split("T")[0]}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button
                      ...
                      onClick={() =>
                        router.push(`scholarship/update/${scholarship.id}`)
                      }
                    >
                      Edit
                    </button>
                      ...
                      onClick={async () => {
                        try {
                          const response = await fetch(
                            `/api/scholarships/adminsOperation?scholarshipId=${scholarship.id}`,
                            { method: "DELETE" },
                          );
