...
export default function QuestionForm({
  ...
  const handleUpdateOptionsData = (
    ...
    transformedQuestion[questionIndex].options[optionIndex].text =
      e.target.value;
  ...
  const decreaseOption = (
    optionIndexToRemove: number,
    questionIndex: number,
  ) => {
    const transformedQuestion = [...question];
    transformedQuestion[questionIndex].options = question[
      questionIndex
    ].options.filter((_, index) => index !== optionIndexToRemove);
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h2 className="text-2xl font-bold mb-6">
        Quality information for the Scholarlships
      </h2>
            ...
            <div className="w-[800px] mx-auto p-4 bg-white rounded-lg shadow-md">
              <div className="p-4 bg-gray-50 rounded-lg mb-4">
                ...
                <div className="space-y-3">
                  {ques.type !== SchFormQuestion.TEXT &&
                ...
                <div className="flex justify-between items-center mt-8">
                  ...
                  <div className="relative mr-auto ml-6">
                    ...
                    >
                      <span>
                        {(ques.type === SchFormQuestion.BOOLEAN
                          ? "Boolean"
                          : "") +
                          (ques.type === SchFormQuestion.RADIO
                            ? "Single choice"
                            : "") +
                          (ques.type === SchFormQuestion.MULTIPLERADIO
                            ? "Multiple Choice"
                            : "") +
                          (ques.type === SchFormQuestion.TEXT
                            ? "Paragraph"
                      ...
                      >
                        <path
                          ...
                          strokeWidth="2"
                          d={
                            ques.isDropDown ? "M5 15l7-7 7 7" : "M19 9l-7 7-7-7"
                          }
                        ></path>
                      </svg>
                    </button>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    >
                      <div
                        className={`absolute left-0 w-10 h-5 rounded-full transition-colors duration-200 ease-in-out ${ques.required ? "bg-indigo-500" : "bg-gray-300"}`}
                      ></div>
                      <div
