...
export default function ElegantCards() {
  const cards = [
    ...
    },
    {
      ...
      title: "Modern Design",
      description:
        "Experience modern UI designs crafted with precision and care.",
      image:
        "https://as1.ftcdn.net/v2/jpg/05/95/47/40/1000_F_595474066_eG9a6YY2uXaZSmFjBMC2HyZY2Wfg7BFi.jpg",
    },
    {
      ...
      description:
        "Unparalleled performance with a focus on speed and responsiveness.",
      image:
        "https://as1.ftcdn.net/v2/jpg/05/95/47/40/1000_F_595474066_eG9a6YY2uXaZSmFjBMC2HyZY2Wfg7BFi.jpg",
    },
  ];
      ...
      <div className="container mx-auto grid gap-12 lg:grid-cols-2 items-center">
        <div>
          ...
          <p className="text-gray-600 text-lg">
            Discover our premium features designed to enhance your experience.
          </p>
        </div>
