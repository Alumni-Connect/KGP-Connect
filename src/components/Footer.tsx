      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="bg-white p-6 px-8 rounded-2xl  text-gray-800">
          ...
          <ul className="mt-4 space-y-2 text-indigo-600">
            {[
              { title: "Apna IIT KGP", link: "http://apna.iitkgp.ac.in/web/" },
              { title: "BIS Corner", link: "https://www.iitkgp.ac.in/bis-corner" },
              { title: "TSG", link: "https://gymkhana.iitkgp.ac.in/" },
              { title: "Student Alumni Cell", link: "https://sac.iitkgp.ac.in/" },
          ...
          <ul className="mt-4 space-y-2 text-indigo-600">
            {[ { title: "Communication Directory", link: "https://www.iitkgp.ac.in/assets/pdf/comdir.pdf" },
             { title: "Prime Minister's Research Fellowship (PMRF)", link: "http://pmrf.in/" },
             { title: "Fee Payment (passed-out students)", link: "http://erp.iitkgp.ac.in/SupplierFacilities/feePaymentPageView.htm" },
              { title: "Degree Verification", link: "http://erp.iitkgp.ac.in/DupCertReqPortal/auth/welcome.htm" },
            ].map((item, index) => (
              <li key={index}>
                <a
                  href={item.link}
        ...
        <div className="bg-white p-4 rounded-2xl  text-gray-800 flex flex-col space-y-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <a href="tel:3222281860" className="text-indigo-500 hover:text-indigo-600 font-medium cursor-pointer">
              3222-281860
            </a>
          </div>
          <div className="flex items-center space-x-3">
            <Mail className="text-red-600" size={22} />
            <a href="mailto:aao@hijli.iitkgp.ac.in" className="text-indigo-500 hover:text-indigo-600 font-medium cursor-pointer">
