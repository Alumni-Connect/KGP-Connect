...
const ApplicationForm = ({user,scholarship}:props) => {
    ...
    const handleChange=(inx:number,e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>,questionIndex:number)=>{
      ...
      <div className="max-w-3xl mx-auto">
         ...
         <div className="bg-white shadow-lg rounded-lg overflow-hidden">
             ...
             <div className="p-6">
              ...
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div className="sm:col-span-3">
                  ...
                  <p className="mt-1 text-xs text-gray-500">These things will be automatically generated</p>
                </div>
              </div>
          ...
          <div className="p-6 space-y-8">
            ...
            {scholarship.scholarship && scholarship.scholarship.formQuestions.map((question:any,questionIndex:any)=>(
              <div key={question.id}>
              {question.type==="TEXT" &&  <div>
              <h3 className="text-lg font-medium text-gray-900">{question.description}</h3>
              <p className="mt-1 text-sm text-gray-500">Be specific and provide examples. (150 words maximum)</p><div className="mt-4">
                <textarea
            ...
            {question.type==="RADIO" && 
                <div>
              <h3 className="text-lg font-medium text-gray-900">{question.description}</h3>
              <p className="mt-1 text-sm text-gray-500">Select the option that best suits you.</p>
            ...
            {question.type==="MULTIPLERADIO" && <div >
                <h3 className="text-lg font-medium">{question.description}</h3>
                <p className="mt-1 text-sm text-gray-500">Select the options that best suit you.</p>
            ...
            <div className="pt-5 border-t border-gray-200">
              <div className="text-sm text-gray-500">
                <p>Application Date: <span className="font-medium">{new Date().toISOString().split('T')[0]}</span></p>
              </div>
