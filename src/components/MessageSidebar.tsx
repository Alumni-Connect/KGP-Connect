...
const contacts = [
  { name: "Udit", image: "https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659652_640.png" },
  { name: "Saransh", image: "https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659652_640.png" },
  { name: "Rushil", image: "https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659652_640.png" },
  { name: "Dhruv", image: "https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659652_640.png" },
];
          ...
          {[...Array(25)].map((_, i) => (
            <div key={i} className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer">
              <Avatar className="border-orange-600 border-2">
                <AvatarImage src="https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659652_640.png" alt="User" />
      ...
      <div className="w-[65%] flex flex-col  h-full ">
        <div className="p-4 border-b flex justify-between items-center">
          ...
          <div className="flex items-center justify-center gap-1">
            <img
              src={"https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659652_640.png"} // Default image if none provided
              alt="Sender"
        ...
        <ScrollArea className="flex-grow p-2 flex flex-col gap-2">
          {messages.map((msg, index) => (
            <div key={index} className={`flex items-end ${msg.sender === "me" ? "justify-end" : ""}`}>
              <div
                className={`p-2 rounded-xl mt-2 max-w-xs w-fit ${msg.sender === "me"
        ...
        <div className="p-4 border-t flex gap-2  ">
          ...
          />
          <Button onClick={sendMessage} className="rounded-full bg-indigo-700 hover:bg-indigo-900 text-white">Send</Button>
        </div>
      </div>
    </Card>
