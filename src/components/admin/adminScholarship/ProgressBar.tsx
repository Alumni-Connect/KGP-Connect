      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex items-center">
          ...
          <div className="ml-4 flex-grow">
            <p className="text-sm font-medium">Your profile can't be found by recruiters because it's missing key information</p>
          </div>
        ...
        <div className="mt-2">
          ...
          <p className="text-sm text-gray-500">You can always search for jobs in other locations and set additional location preferences</p>
          ...
          <div className="mt-2 flex justify-between">
            ...
            <button
              className="px-4 py-1 bg-black text-white text-sm rounded-md hover:bg-gray-800"
            >
              Update now
            </button>
          </div>
