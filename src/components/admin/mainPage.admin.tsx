...
export default function KgpConnectDashboard({
  ...
  useEffect(() => {
    if (activeTab === "users") {
      fetch(`/api/admin/manage-user?page=${page - 1}&limit=${itemsPerPage}`, {
        method: "GET",
      })
        .then(async (res) => {
          if (res.status === 200) {
      ...
      fetch(
        `/api/admin/manage-scholarship?page=${page - 1}&limit=${itemsPerPage}`,
        { method: "GET" },
      )
        .then(async (res) => {
          if (res.status === 200) {
      ...
      fetch(`/api/admin/manage-jobs?page=${page - 1}&limit=${itemsPerPage}`, {
        method: "GET",
      })
        .then(async (res) => {
          if (res.status === 200) {
      ...
      fetch(`/api/admin/manage-post?page=${page - 1}&limit=${itemsPerPage}`, {
        method: "GET",
      })
        .then(async (res) => {
          if (res.status === 200) {
