...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="hidden md:flex flex-col w-[240px] lg:w-[280px] bg-white shadow-sm mt-16 h-fit">
      <div className="relative">
        {/* Cover Image */}
        <div className="w-full h-16 lg:h-20 bg-indigo-800 rounded-lg">
          <img
            src="https://www.iitkgpfoundation.org/images/vault/2638.jpg"
            alt="Cover"
            className="w-full h-24 lg:h-32 bg-white object-cover rounded-t-lg"
          />

          <div className="relative top-[-24px] lg:top-[-32px] flex justify-end p-2">
            <div className="text-white font-light italic text-sm lg:text-lg drop-shadow-md">
              IIT Kharagpur
            </div>
          </div>
        </div>
        ...
        <div className="relative px-4 mt-[-20px] lg:mt-[-24px]">
      ...
      <div className="p-4 border-t">
        <button
          className="w-full p-2 lg:p-3 bg-indigo-600 text-white rounded-lg flex items-center justify-center gap-2 hover:bg-indigo-700 transition-colors shadow-sm font-medium text-sm lg:text-base"
          onClick={() => signOut()}
        >
