...
const GuestHouseBooking = () => {
  return (
    <div>
      <h2 className="text-2xl font-bold border-b pb-2 mb-4"> Guest house Booking </h2>
      <div className="mb-6">
        <p>
      ...
      <div className="mb-6">
        <h3 className="font-semibold">Guest House Booking / Accommodation / Car Hire:</h3>
        <ul className="list-disc pl-6 mt-2 space-y-2">
          <li>Mr. Sadhan Banerjee,</li>
          <li>Ph. (O): 03222-281065;</li>
          <li>Email: sadhan@hijli.iitkgp.ernet.in / alumni@hijli.iitkgp.ernet.in</li>
        </ul>
      </div>
      <div className="mb-6">
        <h3 className="font-semibold">Technology Guest House</h3>
        <ul className="list-disc pl-6 mt-2 space-y-2">
          <li>Air-conditioned single / double bedded rooms, and suites (total 60 beds)</li>
  ...
  <h2 className="text-2xl font-bold mb-4">New Technology Guest House Visveswaraya Guest House</h2>
  <table className="w-full border-collapse border border-gray-300">
    <thead>
      <tr className="bg-gray-200">
        <th className="border border-gray-300 px-4 py-2">Room Type</th>
        <th className="border border-gray-300 px-4 py-2">Occupancy Type</th>
  ...
  <h2 className="text-2xl font-bold mt-6 mb-4">Technology Guest House (Old Wing)</h2>
  <table className="w-full border-collapse border border-gray-300">
    <thead>
      <tr className="bg-gray-200">
        <th className="border border-gray-300 px-4 py-2">Room Type</th>
  ...
  <h2 className="text-2xl font-bold mt-6 mb-4">Technology Guest House (Annex)</h2>
  <table className="w-full border-collapse border border-gray-300">
    <thead>
      <tr className="bg-gray-200">
        <th className="border border-gray-300 px-4 py-2">Room Type</th>
  ...
  <div className="">
        ...
        <table className="w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="border border-gray-300 p-2 text-left">Occupancy Type</th>
              <th className="border border-gray-300 p-2 text-left">Tariff</th>
            </tr>
          </thead>
          <tbody>
            <tr>
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr>
              <td className="border border-gray-300 p-2" rowSpan={2}>D/B AC rooms</td>
              <td className="border border-gray-300 p-2">Single Occupancy</td>
              <td className="border border-gray-300 p-2">400/-</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-2">Double Occupancy</td>
              <td className="border border-gray-300 p-2">600/-</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-2" rowSpan={2}>D/B Non-AC rooms</td>
              <td className="border border-gray-300 p-2">Single Occupancy</td>
            ...
            <tr>
              <td className="border border-gray-300 p-2">Single bedded Non-AC Room</td>
              <td className="border border-gray-300 p-2">Per Room</td>
              <td className="border border-gray-300 p-2">150/-</td>
            </tr>
            <tr>
              <td className="border border-gray-300 p-2">3&4 bedded Non-AC Rooms</td>
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            <tr>
              <td className="border border-gray-300 p-2" rowSpan={2}>Cottages</td>
              <td className="border border-gray-300 p-2">Single Occupancy</td>
              <td className="border border-gray-300 p-2">400/-</td>
            </tr>
            <tr>
