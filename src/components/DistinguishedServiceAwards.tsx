...
const DistinguishedServiceAwards = () => {
  const awardees2021 = [
    ...
    },
    {
      ...
      "year": "1986",
      "degree": "BTech/MF/PH",
      "description": "Director, IFA Steels Pvt. Ltd., Founder & Proprietor, Kapoor Wire Industries Partner, S. R. Kapoor & Sons",
  ...
  const awardees2019=[
    ...
    },
    {
      ...
      "description": "Independent Upstream Consultant, Educator & Start-up Mentor",
  ...
  const awardees2018=[
    ...
    },
    {
      ...
      "description": "Head of Global Development Programmes, London Stock Exchange Group",
      "image": "/DSAwardee2018/6.jpg"
    },
    {
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p>
        Indian Institute of Technology Kharagpur wishes to recognize its alumni for providing outstanding service to the Institute. The Institute is interested in receiving fresh nominations in respect of individual alumnus/alumna for consideration for the award in 2021.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p>
        Any alumnus/alumna may be nominated. However, an alumnus/alumna, who is an employee of IIT Kharagpur, shall not be eligible for the award during his/her service period.
        </p>
        <p className='mt-2'>
        The following aspects will be considered among possible others while assessing the roles and contributions of the Nominee:
        </p>
        <ul className="list-disc pl-6 mt-2 space-y-2">
          <li>Number of years of service to the Alumni Chapters/Foundations and tangible achievements made.</li>
          <li>Number of Alumni-related events organized by the nominee, capacity in which organized, the number of participants in each, tangible outcome in the form of donations collected, etc.</li>
          <li>Endowments created for Chair-Professorships, Scholarship, Centres, Schools, Academy, Lab and other needs of the Institute.</li>
          ...
          <li>Financial support to the Institute through CSR Fund from the Industry.</li>
          <li>Initiative for Industry-Academic collaboration in research & product development.</li>
          <li>Collaboration with IIT Kharagpur in lab to market initiative, product licensing.</li>
          <li>Participating in designing new courses and courses in the interdisciplinary areas.</li>
          <li>No. of International collaboration established like Joint Ph D, Student exchange Program, Joint Research etc.</li>
      ...
      <div className="mb-6">
        ...
        <p>Nominations must be submitted through email latest by <strong>29th October, Friday</strong>. The signed hard copy needs to be sent to the following address by 12th November 2021.</p>
        ...
        <p className="mt-4">
          ...
          with the subject line <strong>'DSA 2021 Nomination'</strong>.It may not be possible to consider nominations received after this date for the current year. However, those will be carried forward for consideration in the future.
        </p>
      </div>
      ...
      <p>
      Process for Selection : Nominations shall be shortlisted by a Screening Committee (SC) chaired by the Dean (OR).The Standing Committee chaired by the Director shall consider all eligible nominations as recommendations from the Screening Committee and make final recommendations to the Board of Governors for approval.
      ...
      <h2 className="text-2xl font-bold border-b pb-2 mb-6 mt-4">DS AWARDEE 2021</h2>
      ...
      <h2 className="text-2xl font-bold border-b pb-2 mb-6 mt-4">DS AWARDEE 2020</h2>
      <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-6 border-b pb-4">
      ...
      <h2 className="text-2xl font-bold border-b pb-2 mb-6 mt-4">DS AWARDEE 2019</h2>
      <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-6 border-b pb-4">
      ...
      <h2 className="text-2xl font-bold border-b pb-2 mb-6 mt-4">DS AWARDEE 2018</h2>
      <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-6 border-b pb-4">
